...
<div class="buttons" ng-if="nowlottery" ng-hide="roundend == true">
    <button class="btn btn-block btn-default"  ng-show="!started" ng-click="startround()" ><span class="glyphicon glyphicon-play"></span>开始</button>
